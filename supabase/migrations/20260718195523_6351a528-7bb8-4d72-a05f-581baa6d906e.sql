...
create type public.app_role as enum (
  'administradora','agente_merito','agente_administrativo','auditor'
);
...
create policy "user reads own roles or administradora reads all" on public.user_roles for select
  using (auth.uid() = user_id or public.has_role(auth.uid(), 'administradora'));
create policy "administradora manages roles" on public.user_roles for all
...
create policy "user reads own profile or administradora reads all" on public.profiles for select
...
create policy "administradora and auditor read audit logs" on public.audit_logs for select
...
create policy "roles read reference documents" on public.reference_documents for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor')
    or public.has_role(auth.uid(),'agente_administrativo'));
create policy "administradora writes reference documents" on public.reference_documents for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
create policy "roles read reference document versions" on public.reference_document_versions for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor')
    or public.has_role(auth.uid(),'agente_administrativo'));
create policy "administradora writes reference document versions" on public.reference_document_versions for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
...
create policy "roles read proponents" on public.proponents for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor')
    or public.has_role(auth.uid(),'agente_administrativo'));
create policy "administradora writes proponents" on public.proponents for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
create policy "roles read proponent aliases" on public.proponent_aliases for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor')
    or public.has_role(auth.uid(),'agente_administrativo'));
create policy "administradora writes proponent aliases" on public.proponent_aliases for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
...
create policy "administradora and auditor read files" on public.files for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor'));
create policy "administradora writes files" on public.files for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
create policy "administradora and auditor read file versions" on public.file_versions for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor'));
create policy "administradora writes file versions" on public.file_versions for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
...
create policy "administradora and auditor read criterion scores" on public.criterion_scores for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor'));
create policy "administradora writes criterion scores" on public.criterion_scores for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
...
create policy "administradora and auditor read evaluations" on public.evaluations for select
  using (public.has_role(auth.uid(),'administradora') or public.has_role(auth.uid(),'auditor'));
create policy "administradora writes evaluations" on public.evaluations for all
  using (public.has_role(auth.uid(),'administradora'))
  with check (public.has_role(auth.uid(),'administradora'));
...
begin
  ...
  from public.criterion_scores where proponent_id = new.proponent_id;
...
declare
  ...
  v_mandatory integer; v_bonus integer; v_zero boolean;
begin
  select
  ...
  from public.criterion_scores where proponent_id = v_proponent_id;
...
begin
  ...
  values (new.id,'A',20),(new.id,'B',50),(new.id,'C',10),(new.id,'D',10),(new.id,'E',10),(new.id,'F',5),(new.id,'G',5);
  return new;
end;
$$;
...
-- 7. Políticas do bucket privado (bucket criado via storage_create_bucket)
create policy "administradora reads dossies bucket" on storage.objects for select
  using (bucket_id = 'dossies-privados' and public.has_role(auth.uid(),'administradora'));
create policy "administradora writes dossies bucket" on storage.objects for insert
  with check (bucket_id = 'dossies-privados' and public.has_role(auth.uid(),'administradora'));
create policy "administradora updates dossies bucket" on storage.objects for update
  using (bucket_id = 'dossies-privados' and public.has_role(auth.uid(),'administradora'));
create policy "administradora deletes dossies bucket" on storage.objects for delete
  using (bucket_id = 'dossies-privados' and public.has_role(auth.uid(),'administradora'));